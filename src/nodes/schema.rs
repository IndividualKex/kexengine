...
const INPUT_PORTS: [[u8; 6]; NodeType::COUNT] = [
    [PortId::Anchor as u8, PortId::Duration as u8, INVALID_PORT, INVALID_PORT, INVALID_PORT, INVALID_PORT],
    [PortId::Anchor as u8, PortId::Duration as u8, INVALID_PORT, INVALID_PORT, INVALID_PORT, INVALID_PORT],
    [PortId::Anchor as u8, PortId::Radius as u8, PortId::Arc as u8, PortId::Axis as u8, PortId::LeadIn as u8, PortId::LeadOut as u8],
    [PortId::Anchor as u8, PortId::Path as u8, PortId::Start as u8, PortId::End as u8, INVALID_PORT, INVALID_PORT],
    [PortId::Anchor as u8, PortId::InWeight as u8, PortId::OutWeight as u8, INVALID_PORT, INVALID_PORT, INVALID_PORT],
    [PortId::Position as u8, PortId::Rotation as u8, INVALID_PORT, INVALID_PORT, INVALID_PORT, INVALID_PORT],
    [PortId::Anchor as u8, INVALID_PORT, INVALID_PORT, INVALID_PORT, INVALID_PORT, INVALID_PORT],
    [PortId::Path as u8, INVALID_PORT, INVALID_PORT, INVALID_PORT, INVALID_PORT, INVALID_PORT],
];
...
const PROPERTIES: [[u8; 7]; NodeType::COUNT] = [
    [PropertyId::RollSpeed as u8, PropertyId::NormalForce as u8, PropertyId::LateralForce as u8, PropertyId::DrivenVelocity as u8, PropertyId::HeartOffset as u8, PropertyId::Friction as u8, PropertyId::Resistance as u8],
    [PropertyId::RollSpeed as u8, PropertyId::PitchSpeed as u8, PropertyId::YawSpeed as u8, PropertyId::DrivenVelocity as u8, PropertyId::HeartOffset as u8, PropertyId::Friction as u8, PropertyId::Resistance as u8],
    [PropertyId::RollSpeed as u8, PropertyId::DrivenVelocity as u8, PropertyId::HeartOffset as u8, PropertyId::Friction as u8, PropertyId::Resistance as u8, INVALID_PROPERTY, INVALID_PROPERTY],
    [PropertyId::DrivenVelocity as u8, PropertyId::HeartOffset as u8, PropertyId::Friction as u8, PropertyId::Resistance as u8, INVALID_PROPERTY, INVALID_PROPERTY, INVALID_PROPERTY],
    [PropertyId::DrivenVelocity as u8, PropertyId::HeartOffset as u8, PropertyId::Friction as u8, PropertyId::Resistance as u8, PropertyId::TrackStyle as u8, INVALID_PROPERTY, INVALID_PROPERTY],
    [INVALID_PROPERTY, INVALID_PROPERTY, INVALID_PROPERTY, INVALID_PROPERTY, INVALID_PROPERTY, INVALID_PROPERTY, INVALID_PROPERTY],
    [INVALID_PROPERTY, INVALID_PROPERTY, INVALID_PROPERTY, INVALID_PROPERTY, INVALID_PROPERTY, INVALID_PROPERTY, INVALID_PROPERTY],
    [INVALID_PROPERTY, INVALID_PROPERTY, INVALID_PROPERTY, INVALID_PROPERTY, INVALID_PROPERTY, INVALID_PROPERTY, INVALID_PROPERTY],
];
